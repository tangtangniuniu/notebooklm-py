...
Introduction to Agents and Agent architecturesNovember 2025Table of contents
...
Introduction to Agents and Agent architecturesNovember 2025it to handle complex, multi-step tasks that a model alone cannot. The critical capability is that
...
Introduction to Agents and Agent architecturesNovember 2025Words are insufficient to describe how humans interact with AI. We tend to
...
Introduction to Agents and Agent architecturesNovember 2025Chain-of-Thought4 or ReAct5) to break down complex goals into steps and decide when
...
Introduction to Agents and Agent architecturesNovember 2025critical components: domain expertise, a defined personality, and seamless integration
...
Introduction to Agents and Agent architecturesNovember 2025At its core, an agent operates on a continuous, cyclical process to achieve its objectives.
...
Introduction to Agents and Agent architecturesNovember 2025This "Think, Act, Observe" cycle continues - managed by the Orchestration Layer, reasoned
...
Introduction to Agents and Agent architecturesNovember 2025
...
Introduction to Agents and Agent architecturesNovember 2025A Taxonomy of Agentic Systems
...
Introduction to Agents and Agent architecturesNovember 2025This fundamental ability to interact with the world - whether using a search tool for a score ,
...
Introduction to Agents and Agent architecturesNovember 2025•  Act: Call the google_places tool with query="coffee shop in Millbrae, CA",
...
Introduction to Agents and Agent architecturesNovember 20253.  Delegates to WebDevAgent: "Generate the new product page HTML based on the
...
Introduction to Agents and Agent architecturesNovember 2025Core Agent Architecture: Model, Tools,
and Orchestration
...
Introduction to Agents and Agent architecturesNovember 2025You may choose more than one model, a "team of specialists." You don't use a sledgehammer
...
Introduction to Agents and Agent architecturesNovember 2025Here are a few of the main types of tools agent builders will put into the “hands” of
...
Introduction to Agents and Agent architecturesNovember 2025This also includes tools for human interaction. An agent can use a Human in the Loop
...
Introduction to Agents and Agent architecturesNovember 2025Core Design Choices
...
Introduction to Agents and Agent architecturesNovember 2025Here, you tell it, You are a helpful customer support agent for Acme Corp, ...
...
Introduction to Agents and Agent architecturesNovember 2025segmented into discrete sub-tasks, and each is assigned to a dedicated, specialized AI agent.
...
Introduction to Agents and Agent architecturesNovember 2025Figure 4: Vertex AI Agent builder from
...
Introduction to Agents and Agent architecturesNovember 2025reviewed by a domain expert before being accepted as valid. Increasingly, the curation and
...
Introduction to Agents and Agent architecturesNovember 2025overviews of performance. Trace data can be seamlessly collected in platforms like Google
...
Introduction to Agents and Agent architecturesNovember 2025Agents and Humans
...
Introduction to Agents and Agent architecturesNovember 2025This opens up a vast array of use cases that are simply impossible with text, from a
...
Introduction to Agents and Agent architecturesNovember 2025Agents and Money
...
Introduction to Agents and Agent architecturesNovember 2025and sensitive data disclosure. You want to give your agent a leash long enough to do its
...
Introduction to Agents and Agent architecturesNovember 2025Identity is distinct from the identity of the user who invoked it and the developer who built it.
...
Introduction to Agents and Agent architecturesNovember 2025For more dynamic security that can adapt to the agent's runtime behavior, ADK provides
...
Introduction to Agents and Agent architecturesNovember 2025Imagine a bustling metropolis with thousands of autonomous vehicles—users, agents, and
...
Introduction to Agents and Agent architecturesNovember 2025Cost and Reliability: The Infrastructure Foundation
...
Introduction to Agents and Agent architecturesNovember 2025How agents learn and self evolve
...
Introduction to Agents and Agent architecturesNovember 2025Example: Learning New Compliance Guidelines
...
Introduction to Agents and Agent architecturesNovember 2025Figure 7: Sample multi agent workflow for compliance guidelines
...
Introduction to Agents and Agent architecturesNovember 2025Examples of advanced agents
...
Introduction to Agents and Agent architecturesNovember 2025Think of the system as a research project manager. The AI first takes a broad research
...
Introduction to Agents and Agent architecturesNovember 2025Endnotes
...
Introduction to Agents and Agent architecturesNovember 202518.  https://google.github.io/adk-docs/
...
Introduction to Agents and Agent architecturesNovember 202538. https://google.github.io/adk-docs/callbacks/design-patterns-and-best-practices
