ESAA: Event Sourcing for Autonomous Agents in
...
tiveassistantstosystemscapableofplanning,executingactionsviatools,anditeratingover
...
cognitive intention from the project’s state mutation, inspired by the Event Sourcing pat-
tern[4]. InESAA,agentsemitonlystructuredintentionsinvalidatedJSON(agent.result
or issue.report); a deterministic orchestrator validates, persists events in an append-only
log(activity.jsonl),appliesfile-writingeffects,andprojectsaverifiablematerializedview
(roadmap.json). The proposal incorporates boundary contracts (AGENT_CONTRACT.yaml),
metaprompting profiles (PARCER), and replay verification with hashing (esaa verify),
ensuring the immutability of completed tasks and forensic traceability. Two case studies
validate the architecture: (i) a landing page project (9 tasks, 49 events, single-agent com-
position) and (ii) a clinical dashboard system (50 tasks, 86 events, 4 concurrent agents
across 8 phases), both concluding with run.status=success and verify_status=ok. The
multi-agentcasestudydemonstratesrealconcurrentorchestrationwithheterogeneousLLMs
(Claude Sonnet 4.6, Codex GPT-5, Antigravity/Gemini 3 Pro, and Claude Opus 4.6), pro-
viding empirical evidence of the architecture’s scalability beyond single-agent scenarios.
Keywords: autonomous agents; event sourcing; software engineering; LLM; orchestration;
constrained output; auditability; multi-agent systems.
1 Introduction
LLM-basedsoftwareengineeringisshiftingfromconversationalinteractionstoagenticworkflows
...
A recurring empirical source for these difficulties is software engineering benchmarks on real
GitHub issues, such as SWE-bench, which aims to measure the ability of agents to produce
coherent and verifiable patches in real-world codebases, moving beyond synthetic and isolated
problems [8]. Even when there is progress in configurations with human validation or restricted
suites, the operational challenge of governance remains: auditing what the agent did, why it did
it, and how to revert with forensic precision [12].
Contemporary multi-agent frameworks like AutoGen [15], MetaGPT [7], and LangGraph [9]
have made significant progress in agent coordination, role assignment, and workflow orches-
tration. However, these systems typically manage state through in-memory data structures or
1
6202
beF
62
...
| database | snapshots, | lacking | the       |       | and   |               |        | guarantees | that |
| -------- | ---------- | ------- | --------- | ----- | ----- | ------------- | ------ | ---------- | ---- |
|          |            |         | immutable | audit | trail | deterministic | replay |            |      |
areessentialforproductionsoftwareengineeringworkflowswhereaccountabilityandreversibility
are non-negotiable.
...
mutablelogofintentions, decisions, andeffects, fromwhichthecurrentstateisdeterministically
...
plexity: a landing page project orchestrated with single-agent composition (9 tasks, 49 events)
andaclinicaldashboardsystem(clinic-asr)orchestratedwithfourheterogeneousLLMagents
operating concurrently (50 tasks, 86 events, 8 completed phases). Both cases demonstrate state
| reproducibility | via | replay | and hash verification. |     |           |     |     |     |     |
| --------------- | --- | ------ | ---------------------- | --- | --------- | --- | --- | --- | --- |
| 2 Related       |     | Work   |                        |     |           |     |     |     |     |
...
andtooloutputsconsumethecontextwindow, anderrorscanpropagatethroughmultipleturns.
...
do not resolve the need for a governance kernel to control effects and maintain an audit trail.
| 2.2 Multi-Agent |     | Frameworks |     |     |     |     |     |     |     |
| --------------- | --- | ---------- | --- | --- | --- | --- | --- | --- | --- |
Recentmulti-agentsystemshaveexploredvariouscoordinationstrategies. AutoGen[15]enables
conversational patterns between agents with role-based specialization. MetaGPT [7] assigns
softwareengineeringroles(architect,developer,tester)todifferentagentswithstructuredoutput
protocols. LangGraph [9] provides a graph-based state machine to define agent workflows with
| conditional | edges | and cycles. |     |     |     |     |     |     |     |
| ----------- | ----- | ----------- | --- | --- | --- | --- | --- | --- | --- |
Althoughtheseframeworksadvanceagentcoordination,theysharecommonlimitationsfrom
...
addressesthesegapsbyapplyingeventsourcingasthefundamentalstatemanagementparadigm.
| Table 1     | presents | a structured | comparison.      |     |             |     |     |     |     |
| ----------- | -------- | ------------ | ---------------- | --- | ----------- | --- | --- | --- | --- |
| 2.3 Context |          | Limits       | and Long-Horizon |     | Degradation |     |     |     |     |
Recent works point to systematic degradation in long context windows, with a drop in recall in
themiddleofthecontext(lost-in-the-middle),affectingtasksthatdependonfactsburiedinlogs,
...
Table 1: Comparison of ESAA with contemporary multi-agent frameworks.
...
| --------- | ----------- | --- | ------- | ------ | --------------- | ------------- | ------------- | --------- | --- | --- | --- |
| 2.5       | Constrained |     |         | Output |                 | and Syntactic |               | Structure |     |     |     |
...
(1) (activity.jsonl): an append-only log of ordered events (event_seq), con-
|     | Event   |     | store       |     |             |          |     |               |     |     |     |
| --- | ------- | --- | ----------- | --- | ----------- | -------- | --- | ------------- | --- | --- | --- |
|     | taining |     | intentions, |     | dispatches, | effects, | and | run closures. |     |     |     |
(2) (roadmap.json): a read-model derived by pure projection; includes
|     | Materialized |     |     | view |     |     |     |     |     |     |     |
| --- | ------------ | --- | --- | ---- | --- | --- | --- | --- | --- | --- | --- |
tasks, dependencies, indexes, and verification metadata (e.g., projection_hash_sha256).
(3) Boundary contracts (AGENT_CONTRACT.yaml, ORCHESTRATOR_CONTRACT.yaml): define
permitted actions per task type (spec/impl/qa), output patterns, and hard prohibitions
|     | (e.g., | denying |     | direct |     | by  | the | agent). |     |     |     |
| --- | ------ | ------- | --- | ------ | --- | --- | --- | ------- | --- | --- | --- |
file.write
3

|     |     | LLM         | Agent | agent.result |     |     | Orchestrator    | appendevent | Event Store |
| --- | --- | ----------- | ----- | ------------ | --- | --- | --------------- | ----------- | ----------- |
...
(.json)
purifiedview
Figure 1: ESAA Orchestration Cycle: the agent emits structured intentions validated by bound-
...
(4) (PARCER_PROFILE.*.yaml): metaprompting profiles that suppress
|     | PARCER |     | profiles |     |     |     |     |     |     |
| --- | ------ | --- | -------- | --- | --- | --- | --- | --- | --- |
...
| --- | ----------- | ------- | ----- | -------- | ------------ | --- | ------- | -------------- | --- |
| 3.2 | Trace-First |         | Model | and      | Immutability |     |         |                |     |
...
| ------- | ----------- | ---------- | --- | --------------- | --- | ----------- | --- | --- | --- |
| 3.4     | Multi-Agent |            |     | Dispatch        | and | Concurrency |     |     |     |
ESAA supports heterogeneous multi-agent orchestration through the append-only semantics of
theeventstore. Theorchestratorassignstaskstoagentsbasedonrole-basedspecialization(e.g.,
...
(ESAA),formalcontractsaredefined(schemas,boundaries,eventvocabulary),andreproducible
...
| ---------------- | ---------------- | -------------- | --- | --- | -------------- | -------- |
| 4.2 Orchestrator |                  | Implementation |     |     | and Validation | Pipeline |
The orchestrator executes a transactional pipeline: (i) validates agent output via JSON Schema
andboundaryrules;(ii)emitsoutput.rejectedforviolations;(iii)applieseffectsviaorchestrator.file.write;
...
Foropenreproducibilitypurposes, theproject’spublicrepositoryprovidesthearchitectureinits
...
compositions.
| 5.1 Case | Study | 1:  | Landing | Page | (Single-Agent | Composition) |
| -------- | ----- | --- | ------- | ---- | ------------- | ------------ |
...
andvalidatetheagents’abilitytoadheretoconstrainedoutputcontracts,theexecutionandarti-
...
specifications in .roadmap/specs/, code files in (vanilla HTML/CSS/JS), and QA reports
src/
in .roadmap/qa/.
Theexecutionfollowedthecycle: attempt.create→orchestrator.dispatch→agent.result
→orchestrator.file.write→task.update→(repeat)→verify.ok→run.end. Thistrail
materializes the idea that the project state is derived from facts, not direct edits [4].
5.2 Case Study 2: Clinical Dashboard (Multi-Agent Concurrency)
The project represents a substantially more complex validation scenario: a clini-
clinic-asr
...
nents: webUI(16tasks),API(11),database(7),testing(7),configuration(4),observability(3),
...
| -------- | ----------- | ---- | ------------- | ---- | ----------- | --- | ----------------- | --- | --- | --- |
| 5.2.2    | Multi-Agent |      | Orchestration |      |             |     |                   |     |     |     |
Four heterogeneous LLM agents were assigned to tasks based on specialization:
• — 10 tasks: database schema specification, API contract definition,
|     | Claude        | Sonnet | 4.6    |         |     |     |     |     |     |     |
| --- | ------------- | ------ | ------ | ------- | --- | --- | --- | --- | --- | --- |
...
| completions |     | had |     |     |     | with positive | validation. |     |     |     |
| ----------- | --- | --- | --- | --- | --- | ------------- | ----------- | --- | --- | --- |
acceptance_results
Akeyobservationistheevidenceofconcurrentmulti-agentexecution: attimestamp2026-02-19T21:55,
...
| 5.2.4 | Progression |     | and | Current | State |     |     |     |     |     |
| ----- | ----------- | --- | --- | ------- | ----- | --- | --- | --- | --- | --- |
...
|          |        |        | Table 2:        | Quantitative |      | comparison | of  | the two | case          | studies. |     |     |
| -------- | ------ | ------ | --------------- | ------------ | ---- | ---------- | --- | ------- | ------------- | -------- | --- | --- |
...
studies, the count was zero, suggesting that the constrained output regime
output.rejected
...
| --------- | ------------ | ---------- | --------- | --------- | ------------- | --------- | ------ | -------- | --- | --- | --- | --- |
| 6.2       | Auditability |            | and       | Debugging |               | through   | Replay |          |     |     |     |     |
...
| 6.3 | Multi-Agent |     | Coordination |     |     | via Event | Store |     |     |     |     |     |
| --- | ----------- | --- | ------------ | --- | --- | --------- | ----- | --- | --- | --- | --- | --- |
The case study demonstrates that the event store serves as a natural coordination
clinic-asr
...
| --- | ------------ | --- | ------------ | ------ | ---- | --------- | ------- | --- | -------- | --- | -------------- | --- |
|     | 3.           |     | progression: |        | the  |           |         |     |          |     |                | se- |
|     | Phase-gated  |     |              |        |      | promote   | → claim | →   | complete | →   | phase.complete |     |
quence enforces dependency ordering without requiring agents to be aware of each other,
|     | reducing |     | coordination | overhead. |     |     |     |     |     |     |     |     |
| --- | -------- | --- | ------------ | --------- | --- | --- | --- | --- | --- | --- | --- | --- |
7

| 6.4 Context | Efficiency | and Degradation | Mitigation |     |     |     |
| ----------- | ---------- | --------------- | ---------- | --- | --- | --- |
ESAA proposes that the agent should not carry long-term memory in the raw prompt; it should
receiveapurifiedview(roadmap+relevantfacts)derivedfromthelog. Thisapproachaddresses
...
dows [10]. In the case, with 50 tasks and complex interdependencies, the purified
clinic-asr
view mechanism was essential for maintaining agent coherence over the 15 hours of execution.
| 6.5 Security | and Blast | Radius |     |     |     |     |
| ------------ | --------- | ------ | --- | --- | --- | --- |
...
log of occupies approximately 15KB). These costs are negligible compared to LLM
clinic-asr
...
| diversity [17]. |     |     |     |     |     |     |
| --------------- | --- | --- | --- | --- | --- | --- |
Results from a landing page and a clinical POC do not necessarily
| External | validity. |     |     |     |     |     |
| -------- | --------- | --- | --- | --- | --- | --- |
...
success,andESAAmustbetestedonworkloadsalignedwithSWE-benchandhardervariants[8,
12].
Construct validity. Measures such as output.rejected and verify_status capture com-
plianceandstatereproducibilitybutdonotdirectlymeasure"designquality"or"businessvalue"
of the software. To broaden constructs, it is recommended to include human evaluations and
| quality metrics | (e.g., test | coverage, accessibility, | maintainability). |                  |             |        |
| --------------- | ----------- | ------------------------ | ----------------- | ---------------- | ----------- | ------ |
|                 |             | Two case studies         | (n=2) improve     | upon the initial | single-case | design |
| Conclusion      | validity.   |                          |                   |                  |             |        |
but still limit statistical inferences. The appropriate conclusion is that ESAA demonstrates
technical feasibility and produces verifiable invariants in scenarios of different complexities, not
| that it maximizes | performance | on any benchmark. |     |     |     |     |
| ----------------- | ----------- | ----------------- | --- | --- | --- | --- |
8
...
Future work includes: (i) an official CLI (esaa init/run/verify) with integration to re-
mote repositories; (ii) conflict detection and resolution strategies for concurrent file modifica-
tions; (iii) automated time-travel debugging with visual diff comparison of projections at ar-
bitrary event points; (iv) systematic evaluation on real-world issue benchmarks (SWE-bench)
and enterprise-scale projects [8, 12]; and (v) formal verification of orchestrator invariants using
model checking techniques.
References
[1] JSONSchema.(2020).JSONSchemaspecification(Draft2020-12).https://json-schema.
...
html
[6] GitLab. (2025). Advisory: DoS vulnerability in XGrammar used in vLLM (GHSA report
...
[10] Liu, N. F., Lin, K., Hewitt, J., Paranjape, A., Bevilacqua, M., & Liang, P. (2024). Lost in
...
[11] OWASP. (2021). OWASP Top 10:2021. https://owasp.org/Top10/2021/
...
[15] Wu, Q., et al. (2023). AutoGen: Enabling next-gen LLM applications via multi-agent con-
...
2210.03629
A Agent Output Contract JSON Schema
{
...
| B   | Roadmap |     | Read-Model |     |     | JSON | Schema |     |     |
| --- | ------- | --- | ---------- | --- | --- | ---- | ------ | --- | --- |
{
| "$schema": |                                                 | "https://json-schema.org/draft/2020-12/schema", |         |              |     |     |     |     |     |
| ---------- | ----------------------------------------------- | ----------------------------------------------- | ------- | ------------ | --- | --- | --- | --- | --- |
...
| --------------------- | --- | --- | -------- | --------- | ----- | --------- | ----------- | --------- | --- | ------------------- | --- | --- |
|                       |     |     | Agent    | intention |       | (patch    | proposals), | validated |     | by schema/boundary. |     |     |
agent.result
...
| ----------- | --- | --- | ------- | --- | ----- | -------------- | -------- | --- | --- | --- | --- | --- |
task.update Updates task state (e.g., todo → in_progress → done).
verify.start Starts audit via replay + deterministic hashing.
| verify.ok |     |     | Audit | passed; |     | records projection_hash_sha256. |     |     |     |     |     |     |
| --------- | --- | --- | ----- | ------- | --- | ------------------------------- | --- | --- | --- | --- | --- | --- |
...
| --------------- | ----- | ------------- | --------- | ------- | -------------------- | ---------- | -------- | ------------- | --------- | ------ | ----- | --- |
|                 | Table | 4: Simplified |           | event   | vocabulary           | observed   |          | in clinic-asr |           | (CS2). |       |     |
...
The simplification from 15 to 5 event types reflects a design insight: internal orchestrator
...
def hash_input(projected_state):
12

| # Avoid | self-reference: | exclude run | metadata | and hash field |
| ------- | --------------- | ----------- | -------- | -------------- |
return {
...
def compute_projection_hash(projected_state):
...
E Representative Extract from activity.jsonl (CS2: clinic-asr)
Thefollowingextractillustratesconcurrentmulti-agentexecutionintheclinic-asreventstore
...
| "acceptance_results":{"Rules |     | documented":true}} |     |     |
| ---------------------------- | --- | ------------------ | --- | --- |
{"ts":"2026-02-19T21:56:20","action":"complete","task_id":"T-2302",
"agent_id":"claude-opus-4-6",
| "acceptance_results":{"Events |     | documented":true}} |     |     |
| ----------------------------- | --- | ------------------ | --- | --- |
13